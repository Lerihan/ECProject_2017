...
class Model{
    ...
    protected $_orderBy;
    protected $_DBName = 'uploads';
    protected $_additions = ['ID'];
    protected $_exclusions = ['_connection','_className','_classProps','_exclusions','_additions','_DBName','_insert','_update','_delete','_selectOne','_selectAll','_whereClause', '_orderBy'];//list PDOLayer properties here
    ...
    public function oldwhere($assocArray)// array('color'=>'red')
    {
    ...
    public function get(){
        $select = $this->_selectAll . $this->_whereClause . $this->_orderBy;
